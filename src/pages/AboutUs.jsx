...
const AboutUs = () => {
  return (
    <>
      <Helmet>
        <title>Best Furniture | About Us</title>
      </Helmet>
      <div className=" font-[sans-serif] text-gray-800 bg-gray-100 px-6 py-32">
        <div className="md:max-w-7xl  grid lg:grid-cols-2 gap-8 max-lg:max-w-2xl mx-auto">
