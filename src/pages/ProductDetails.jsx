...
const ProductDetails = () => {
  ...
  const { title, imageUrl, price, brand, description,  } = product;
        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <p className="mb-12 leading-relaxed">{description}</p>
              
              <div className="flex">
                <span className="title-font font-medium text-4xl text-gray-900">
                  ${price}
                </span>
                <span className="ml-3 title-font font-medium text-lg line-through text-gray-400">
                  ${price}
                </span>
