const Features = () => {
  return (
    <>
      <div className="my-20 max-w-6xl mx-auto font-[sans-serif] text-[#333]">
      <div className="text-center mb-20">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
          <div className="p-4 text-center">
            ...
            We have a dedicated 24/7 customer care service.
            </p>
          </div>
          <div className="p-4 text-center">
            <svg
            ...
            <p className="text-gray-500 text-sm">
            We provide fastest home delivery all over Bangladesh.
            </p>
          </div>
          <div className="p-4 text-center">
            <svg
          ...
          <div className="p-4 text-center">
            ...
            <h3 className="text-xl font-semibold mb-2">ASSEMBLING & SHIFTING</h3>
            <p className="text-gray-500 text-sm">
            Expert team ready for assembling & shifting service.
            </p>
          </div>
          <div className="p-4 text-center">
            <svg
            ...
            <h3 className="text-xl font-semibold mb-2">ONE YEAR WARRANTY</h3>
            <p className="text-gray-500 text-sm">
            We provide one year service warranty for all Products
            </p>
          </div>
          <div className="p-4 text-center">
            <svg
            ...
            <p className="text-gray-500 text-sm">
            Our dedicated team available for your service 24/7.
            </p>
          </div>
        </div>
      </div>
